# Practical-Pathobiological-Dictionary-Defining-Pathomics-Features
...
•	Input:
o	None (standard and third-party libraries).
•	Process:
o	2.1 Import essential libraries for system operations and utility functions:
	os, shutil, inspect, datetime.
o	2.2 Import data manipulation and numerical computation libraries:
	pandas as pd, numpy as np.
o	2.3 Import visualization libraries:
	matplotlib.pyplot as plt, seaborn as sns.
o	2.4 Import scikit-learn modules for data preprocessing:
...
o	2.5 Import scikit-learn modules for model selection and evaluation:
...
o	2.6 Import feature selection methods:
	SelectKBest, chi2, f_classif, mutual_info_classif.
o	2.7 Import machine learning classifiers:
...
o	2.8 Enable experimental features if necessary (e.g., enable_iterative_imputer).
•	Output:
o	All necessary libraries are imported and ready for use in the script.
________________________________________
 **Step 3: Parameters Configuration**
•	Input:
o	None (parameters are defined within the script).
•	Process:
o	3.1 General Settings:
...
o	3.2 Classes Selection and Mapping:
...
o	3.3 Class Selection Percentages:
...
o	4.2 Diagnostics Before Mapping:
...
o	4.3 Data Filtering and Shuffling:
...
o	4.4 Class Selection by Percentage:
...
•	Output:
o	Prepared Patient_ID, Data, and Outcome variables for further processing.
________________________________________
 **Step 5: Preprocessing**
•	Input:
o	Data, Outcome.
•	Process:
o	5.1 Stratified Splitting:
...
•	Output:
o	X_train_scaled and X_test_scaled: Preprocessed feature matrices ready for feature selection and modeling.
________________________________________
 **Step 6: Feature Selection**
•	Input:
o	X_train_scaled, y_train, feature selectors, NOF.
•	Process:
o	6.1 Define Feature Selector Functions:
...
•	Output:
o	Feature selector functions are ready to be applied.
________________________________________
 **Step 7: Applying Feature Selection and Classifiers**
•	Input:
o	Preprocessed data (X_train_scaled, X_test_scaled), y_train, y_test, Patient_ID_train, Patient_ID_test, feature selectors, classifiers, grid search configuration.
•	Process:
o	7.1 Initialize Storage Structures:
...
•	Output:
o	Results including evaluation metrics, selected features, confusion matrices, and best hyperparameters are collected and ready for saving.
________________________________________
Step 8: Saving and Aggregating Results
•	Input:
o	Collected results from Step 7.
•	Process:
o	8.1 Aggregate Metrics:
...
o	8.3 Save Confusion Matrices:
	8.3.1 Save all confusion matrices to confusion_matrices.csv.
o	8.4 Copy Original Data File:
	8.4.1 Copy the original data file to the results_directory for reference.
•	8.5 Save Workflow and Code:
o	8.5.1 Save the workflow description as Workflow_Ver18.txt.
o	8.5.2 Save the script code as Code_Ver18.py:
	Use inspect.getsource to retrieve the code.
o	Handle exceptions if inspect cannot retrieve the code.
•	8.6 Save Best Hyperparameters:
o	8.6.1 Combine best hyperparameters from all classifiers and feature selectors.
o	8.6.2 Save to best_parameters.csv in Tuning_Hyperparameters.
•	Output:
o	All results are saved in the organized results_directory.
________________________________________
Step 9: Final Output Messages
•	Input:
o	None.
•	Process:
o	9.1 Print messages summarizing the completion of the script and locations of saved files:
